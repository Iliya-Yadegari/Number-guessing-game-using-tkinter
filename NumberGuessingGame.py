...
submit_btn = Button(window,text = 'Submit',width = 20,height = 3,command = lambda: ngm.main_fun(lower_ent.get(),upper_ent.get(),window)).grid(row = 2, column = 0, padx = 10, pady = 10)
